...
class ContextSensitiveDrop < Liquid2::Drop
  def test
    @context['test']
  end
end

class Category < Liquid2::Drop
  attr_accessor :name
...
class CounterDrop < Liquid2::Drop
  def count
    @count ||= 0
    @count += 1
  end
...
class ContextTest < Test::Unit::TestCase
  ...
  def test_scoping
    ...
    assert_raise(Liquid2::ContextError) do
      @context.pop
    end
