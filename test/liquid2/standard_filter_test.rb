...
class Filters
  include Liquid2::StandardFilters
end
...
class StandardFiltersTest < Test::Unit::TestCase
  ...
  def test_map_doesnt_call_arbitrary_stuff
    assert_equal "", Liquid2::Template.parse('{{ "foo" | map: "__id__" }}').render
    assert_equal "", Liquid2::Template.parse('{{ "foo" | map: "inspect" }}').render
  end

  def test_map_calls_to_liquid
    t = TestThing.new
    assert_equal "woot: 1", Liquid2::Template.parse('{{ foo }}').render("foo" => t)
  end
  ...
  def test_map_over_proc
    ...
    assert_equal "testfoo", Liquid2::Template.parse(templ).render("procs" => [p])
  end
