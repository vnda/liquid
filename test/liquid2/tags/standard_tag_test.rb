...
class StandardTagTest < Test::Unit::TestCase
  ...
  def test_tag
    tag = Tag.new('tag', [], [])
    assert_equal 'liquid2::tag', tag.name
  ...
  def test_assign_from_case
    ...
    template = Liquid2::Template.parse(code)
  ...
  def test_assign
    assert_equal 'variable', Liquid2::Template.parse( '{% assign a = "variable"%}{{a}}'  ).render
  end

  def test_assign_an_empty_string
    assert_equal '', Liquid2::Template.parse( '{% assign a = ""%}{{a}}'  ).render
  end

  def test_assign_is_global
    assert_equal 'variable',
                 Liquid2::Template.parse( '{%for i in (1..2) %}{% assign a = "variable"%}{% endfor %}{{a}}'  ).render
  end
